# Generated by Django 3.2.13 on 2022-11-15 05:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy', multiselectfield.db.fields.MultiSelectField(choices=[('호두', '호두'), ('아황산류', '아황산류'), ('게', '게'), ('대두', '대두'), ('돼지고기', '돼지고기'), ('쇠고기', '쇠고기'), ('조개류', '조개류'), ('새우', '새우'), ('오징어', '오징어'), ('토마토', '토마토'), ('해당없음', '해당없음'), ('닭고기', '닭고기'), ('복숭아', '복숭아'), ('메밀', '메밀'), ('밀', '밀'), ('난류', '난류'), ('땅콩', '땅콩'), ('고등어', '고등어'), ('우유', '우유')], max_length=67)),
